...
<center>  
       <h2><span style="color:#a442f4">Update User</span></h2>
</center>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="<%=request.getContextPath()%>/adminUpdateUser/${user.id}" id="user" method="POST">
                                    <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>User ID</label>
                                                <div class="form-control" placeholder="" name="id" value="${user.id}">${user.id}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="password" value="${user.password}"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Enabled</label>
                                                <input type="text" class="form-control" placeholder="" name="password" value="${user.enabled}"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Role</label>
                                                <input type="text" class="form-control" placeholder="" name="password" value="${user.role}"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" class="btn btn-info btn-fill pull-right" value="Update User"/>
