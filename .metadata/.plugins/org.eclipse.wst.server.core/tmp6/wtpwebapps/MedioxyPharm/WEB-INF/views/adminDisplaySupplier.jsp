...
<center>  
       <h2><span style="color:#a442f4">Display Supplier</span></h2>
</center>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Supplier List</h4>
                                 ...
                                 <c:forEach items="${supplierList}" var="supplier">
                                    ...
                                    <tbody>
                                        <tr>
                                        	...
                                        	<td>${supplier.suppDesp}</td>
                                            <td><a href="<c:url value="adminUpdateSupplier/${supplier.suppId}"/>">Update</a> ||
                                            <a href="<c:url value="deleteSupplier/${supplier.suppId}"/>">Delete</a></td>
                                        </tr>
                                 </c:forEach>       
                                    </tbody>
                                </table>
