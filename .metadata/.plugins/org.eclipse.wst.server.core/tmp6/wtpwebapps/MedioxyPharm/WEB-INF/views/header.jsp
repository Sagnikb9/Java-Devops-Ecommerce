        ...
        <div class="container">
            ...
            <div class="col-md-6" data-animate="fadeInDown">
                <ul class="menu">
                           ...
                           <li><a href="register" data-toggle="modal" data-target="#login-modal1">Register</a>
                           </li>  
                           <li><a href="contact">Contact</a></li> 
                           <li><a href="account">${sessionScope.username}</a></li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="password-modal" placeholder="Password" name="enabled" value="TRUE">
                            </div>
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="password-modal" placeholder="Password" name="role" value="ROLE_USER">
                            </div>
                            <p class="text-center">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="#" data-animate-hover="bounce">
                    <img src="img/logo.jpg" alt="logo" class="hidden-xs">
                    <img src="img/logo-small.jpg" alt="logo" class="visible-xs"><span class="sr-only"></span>
                </a>
