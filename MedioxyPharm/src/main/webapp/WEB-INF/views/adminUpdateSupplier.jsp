...
<center>  
       <h2><span style="color:#a442f4">Update Supplier</span></h2>
</center>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="<%=request.getContextPath()%>/adminUpdateSupplier/${supplier.suppId}" id="supplier" method="POST">
                                    <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control" placeholder="" name="suppId" value="${supplier.suppId}">${supplier.suppId}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Supplier Name</label>
                                                <input type="text" class="form-control" placeholder="" name="suppName" value="${supplier.suppName}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <label>Supplier Description</label>
                                                <textarea id="myTextarea2" class="form-control" placeholder="" name="suppDesp">${supplier.suppDesp}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" class="btn btn-info btn-fill pull-right" value="Update Supplier"/>
